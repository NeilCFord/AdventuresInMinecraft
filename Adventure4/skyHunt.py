...
def placeTreasure():
  ...
  treasure_y = random.randint(y+2, y+RANGE)
...
def checkHit():
  ...
  for e in events:
    ...
    if x == treasure_x and y == treasure_y and z == treasure_z:
      mc.postToChat("HIT!")
      # Increase the score
      score = score + 10
...
def homingBeacon():
  ...
  if treasure_x != None:
    ...
    if timer == 0:
      ...
      diffx = abs(x - treasure_x)
      diffy = abs(y - treasure_y)
      diffz = abs(z - treasure_z)
